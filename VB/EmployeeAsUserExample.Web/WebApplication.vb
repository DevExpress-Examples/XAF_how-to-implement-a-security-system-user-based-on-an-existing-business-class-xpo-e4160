...
Namespace EmployeeAsUserExample.Web
    Partial Public Class EmployeeAsUserExampleAspNetApplication
        ...
        Private Sub EmployeeAsUserExampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
            e.Updater.Update()
            e.Handled = True
        End Sub
...
'            Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.EmployeeAsUserExampleAspNetApplication_DatabaseVersionMismatch)
